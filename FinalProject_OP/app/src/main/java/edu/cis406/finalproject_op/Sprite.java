...
public class Sprite {
    ...
    private float width=128,height=64;//height/width to be drawn on the screen
    private int spriteX=8,spriteY=2; // the x,y position of the image from sprite sheet
